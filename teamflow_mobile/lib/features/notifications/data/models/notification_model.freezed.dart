...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,userId,senderId,type,title,body,isRead,createdAt);

@override
String toString() {
  return 'NotificationModel(id: $id, userId: $userId, senderId: $senderId, type: $type, title: $title, body: $body, isRead: $isRead, createdAt: $createdAt)';
}
...
class _NotificationModel implements NotificationModel {
  const _NotificationModel({required this.id, required this.userId, required this.senderId, required this.type, required this.title, required this.body, required this.isRead, required this.createdAt});
